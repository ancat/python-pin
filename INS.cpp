...
PyObject* Python_INS_MemoryOperandSize(PyObject* self, PyObject* args) {
    PyObject* ins;
    PyObject* memoryop;
    PyArg_ParseTuple(args, "L|L", &ins, &memoryop);

    INS ins_object = *(INS*) ins;
    UINT32 memoryop_object = *(UINT32*) memoryop;
...
PyObject* Python_OPCODE_StringShort(PyObject* self, PyObject* args) {
    ...
    UINT32 opcode_object = *(UINT32*) opcode;
...
PyObject* Python_INS_RegR(PyObject* self, PyObject* args) {
    PyObject* x;
    PyObject* k;
    PyArg_ParseTuple(args, "L|L", &x, &k);

    INS x_object = *(INS*) x;
    UINT32 k_object = *(UINT32*) k;
...
PyObject* Python_CATEGORY_StringShort(PyObject* self, PyObject* args) {
    PyObject* num;
    PyArg_ParseTuple(args, "L", &num);

    UINT32 num_object = *(UINT32*) num;
...
PyObject* Python_INS_OperandIsAddressGenerator(PyObject* self, PyObject* args) {
    PyObject* ins;
    PyObject* n;
    PyArg_ParseTuple(args, "L|L", &ins, &n);

    INS ins_object = *(INS*) ins;
    UINT32 n_object = *(UINT32*) n;
...
PyObject* Python_INS_MemoryOperandIsRead(PyObject* self, PyObject* args) {
    PyObject* ins;
    PyObject* memopidx;
    PyArg_ParseTuple(args, "L|L", &ins, &memopidx);

    INS ins_object = *(INS*) ins;
    UINT32 memopidx_object = *(UINT32*) memopidx;
...
PyObject* Python_INS_Invalid(PyObject* self, PyObject* args) {
    return Py_BuildValue("L", INS_Invalid());
}
...
// FIXME: as_read_object is always true
PyObject* Python_INS_ChangeReg(PyObject* self, PyObject* args) {
    PyObject* ins;
    PyObject* old_reg;
    PyObject* new_reg;
    PyObject* as_read;
    PyArg_ParseTuple(args, "L|L|L|O", &ins, &old_reg, &new_reg, &as_read);

    INS ins_object = *(INS*) ins;
    REG old_reg_object = *(REG*) old_reg;
    REG new_reg_object = *(REG*) new_reg;
    BOOL as_read_object = true;

    if (INS_ChangeReg(ins_object, old_reg_object, new_reg_object, as_read_object)) {
        return Py_BuildValue("O", Py_True);
    } else {
        return Py_BuildValue("O", Py_False);
    }
